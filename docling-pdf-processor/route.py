...
from schema import BatchConversionJobResult, ConversationJobResult, ConversionResult
from service import DocumentConverterService, DoclingDocumentConversion
